...
def output_input_adder(out_bit_values):
    ...
    solver = cp_model.CpSolver()
    # BEGIN STUDENT CODE
    collector = SolutionCollector(a_bits, b_bits)
    collector.variables = variables
    collector.solutions = solutions
...
class SolutionCollector(cp_model.CpSolverSolutionCallback):
    ...
    def OnSolutionCallback(self):
        # BEGIN STUDENT CODE
        a_vals = [self.Value(self.variables[a]) for a in self.a_bits]
        b_vals = [self.Value(self.variables[b]) for b in self.b_bits]
        self.solutions.append((a_vals, b_vals))
        # END STUDENT CODE
